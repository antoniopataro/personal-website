...
export default function Document() {
  return (
    <Html lang="en">
      ...
      <meta
        name="description"
        content="Hello! I'm Antonio, a passionate Front-End Dev. from Brazil who's very experienced at building modern, performatic and UX-first applications for tech-oriented solutions. Hope you like my website!"
      />
